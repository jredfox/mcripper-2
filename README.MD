...
- `verify` verifies the integraty of your current archive downloads. As checking the hash integraty of every download would slow down the process and mojang's files don't always read the hash the json/url provides
